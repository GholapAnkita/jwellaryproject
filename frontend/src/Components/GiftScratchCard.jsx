        ...
        <>
            ...
            <div className="fixed bottom-6 right-6 z-40 group">
                ...
                <button
                    ...
                    className="relative bg-linear-to-br from-yellow-400 via-amber-500 to-yellow-600 text-gray-950 p-4 rounded-full shadow-2xl flex items-center justify-center border border-yellow-300 hover:scale-110 active:scale-95 transition duration-300 cursor-pointer"
            ...
            {isOpen && (
                <div className="fixed inset-0 bg-black/75 backdrop-blur-md flex justify-center items-center z-50 p-4">
                    <div className="bg-linear-to-b from-stone-900 via-stone-950 to-stone-900 border border-yellow-500/30 p-5 sm:p-8 rounded-3xl shadow-2xl w-full max-w-[340px] sm:max-w-sm relative text-center overflow-hidden animate-scale-up">
                        ...
                        <div className="bg-stone-950 border border-yellow-500/10 p-4 sm:p-5 rounded-2xl relative overflow-hidden min-h-[150px] flex flex-col justify-center items-center shadow-inner">
                            {!isScracked ? (
                                <div 
                                    ...
                                    className="absolute inset-1 bg-linear-to-br from-yellow-600 via-amber-500 to-yellow-700 rounded-xl cursor-pointer flex flex-col justify-center items-center p-3 sm:p-4 text-center shadow-lg transition duration-500 hover:brightness-110 active:scale-98 select-none"
                                >
