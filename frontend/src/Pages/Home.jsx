...
const Home = () => {
  return (
    <div className="text-center py-12 sm:py-20 md:py-32 px-4 bg-linear-to-br from-stone-50 via-stone-100/40 to-yellow-50/15 min-h-screen flex flex-col justify-center relative overflow-hidden font-sans">
      ...
      <div className="absolute top-0 bottom-0 left-1/2 w-px bg-linear-to-b from-yellow-600/0 via-yellow-600/10 to-yellow-600/0 hidden md:block"></div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="font-serif text-3xl sm:text-5xl md:text-7xl font-bold tracking-tight mb-4 bg-linear-to-r from-yellow-700 via-amber-600 to-yellow-800 bg-clip-text text-transparent py-1">
            HandCrafted Jewellery by Ankita
          </h1>
          <div className="w-20 h-0.5 bg-linear-to-r from-yellow-600 to-amber-500 mx-auto rounded-full mt-4"></div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
          <Link
            to="/products"
            className="bg-linear-to-r from-yellow-500 to-amber-600 text-gray-950 px-8 py-4 rounded-full hover:from-yellow-600 hover:to-amber-700 transition duration-300 transform hover:scale-105 shadow-xl font-bold uppercase tracking-widest text-xs w-full sm:w-auto border border-yellow-500/15"
          >
            🛍️ Browse Collection
          </Link>
          <Link
